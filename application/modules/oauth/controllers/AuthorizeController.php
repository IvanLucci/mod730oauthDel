...
class Oauth_AuthorizeController extends Zend_Controller_Action {
    ...
    public function indexAction() {
    	...
    	//Vai alla pagina delle deleghe e ruoli
    ...
    protected function processApprove($data) {
        ...
        //If a delegation or a role has been used, send notification and/or update log file
        if(isset($sd->delegator)){
        	...
        	$writer = new Zend_Log_Writer_Stream(realpath(APPLICATION_PATH . '/log/log.log'));
        	$logger = new Zend_Log($writer);
        	$logger->info(Zend_Auth::getInstance()->getIdentity() . ' accessed to ' . $sd->delegator . ' data. Scopes: ' . $scopes);
